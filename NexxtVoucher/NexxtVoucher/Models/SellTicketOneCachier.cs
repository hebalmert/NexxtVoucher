...
{
    public class SellTicketOneCachier
    {
        [Key]
        public int SellTicketOneCachierId { get; set; }

        [Required(ErrorMessageResourceType = typeof(Resource), ErrorMessageResourceName = "Required")]
        [Range(1, double.MaxValue, ErrorMessageResourceType = typeof(Resource), ErrorMessageResourceName = "Msg_Range")]
        [Index("SellTicketOneCachier_Company_VentaOne_Index", 1, IsUnique = true)]
        ...
        [Index("SellTicketOneCachier_Company_VentaOne_Index", 2, IsUnique = true)]
